...
const COUNTRIES = [
  ...
  "Singapore", "Canada", "Germany", "Malaysia", "Other",
];
...
const DemoModal = ({ open, onClose }: DemoModalProps) => {
  ...
  const handleSubmit = async () => {
    ...
    window.open(`mailto:saicharan652@gmail.com?subject=${subject}&body=${body}`, "_blank");
  ...
  const handleClose = () => {
    ...
    setTimeout(() => {
      setSuccess(false);
      setForm({ email: "", gender: "", country: "", parentName: "", attendedBefore: "", course: "" });
      setErrors({});
    }, 300);
  };
  ...
  const selectClass = "w-full bg-background border border-border rounded-lg px-3.5 py-3 text-foreground text-[.92rem] outline-none transition-all focus:border-primary/50 focus:ring-2 focus:ring-primary/10 appearance-none";
  const inputClass = "w-full bg-background border border-border rounded-lg px-3.5 py-3 text-foreground text-[.92rem] outline-none transition-all focus:border-primary/50 focus:ring-2 focus:ring-primary/10 placeholder:text-muted-foreground/40";
  const labelClass = "block text-[.74rem] font-bold tracking-[.07em] uppercase text-foreground/60 mb-1.5";
  ...
  return (
    ...
    >
      <div className="bg-card border border-border rounded-[20px] w-full max-w-[520px] relative overflow-hidden max-h-[92vh] overflow-y-auto shadow-2xl">
        ...
        <div className="p-9 sm:p-10">
          {!success ? (
            <>
              ...
              <h2 className="font-heading text-[1.65rem] font-black mb-2 text-foreground">Book Your Free Demo</h2>
              ...
              <div className="mb-4">
                ...
                <input type="email" value={form.email} onChange={(e) => setForm({ ...form, email: e.target.value })} placeholder="Enter your email" className={inputClass} />
              ...
              <div className="mb-4">
                ...
                <input type="text" value={form.parentName} onChange={(e) => setForm({ ...form, parentName: e.target.value })} placeholder="Enter parent's name" className={inputClass} />
              ...
              <div className="mb-4">
                ...
                <select value={form.attendedBefore} onChange={(e) => setForm({ ...form, attendedBefore: e.target.value })} className={selectClass}>
            ...
            <div className="text-center py-4">
              ...
              <p className="text-muted-foreground text-[.88rem] leading-[1.7] mb-6">
                Thank you! We&apos;ve received your details and will <strong className="text-foreground">WhatsApp you within 24 hours</strong> to confirm your free demo class slot.
              </p>
              <a
